...
export function ModuleCard({
	...
	return (
		<div ref={rootRef} id={String(id)} data-module-id={String(id)} className={cn('h-full rounded-lg border bg-card text-card-foreground shadow-sm hover:shadow-md transition-shadow flex flex-col relative')}> 
